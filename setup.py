...
setup(
    ...
    ext_modules=[
        Extension(
            ...
            extra_objects=['clib/swmm/bin/libswmm5.a', 'clib/autocache/libautocache.a'],
            include_dirs=[dirname(path), 'clib/autocache', 'clib/Stormwater-Management-Model/src/solver/include']
        )
